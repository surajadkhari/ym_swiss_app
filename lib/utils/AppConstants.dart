class AppConstants {
  //API END POINT
  // static String BASE_URL = 'http://143.244.143.108';
/*  // static String BASE_URL = 'http://103.69.125.98';
  // static String REGISTER_URI = '/api/register';
  // static String RESET_PASSWORD_URI = '';
  ...
  static String FORGET_PASSWORD_URI = '/api/forgot-password';
  static String OTP_VERIFY_URI = '/api/otp/verify';
  static String RESEND_OTP_VERIFY_URI = '/api/otp/resend';
  static String SEARCH_URI = '/api/search/complain';
  static String PUBLIC_COMPLAIN = '/api/public/complains';
  static String PUBLIC_POST_COMPLAIN_URI = '/api/public/complains';

  ///SHARE PREFERENCE

  static const String FIST_TIME_ON_APP = 'fistTimeOnApp';
  ...
  ///Splash Screen
  static String APP_NAME = 'श्रम संसार';
  static String COPY_RIGHT_TOP =
      'Copyright | All rights reserved Dhangadi Municipality ';
  static String COPY_RIGHT_BOTTOM = 'Developed  By \n Young Minds Creation ';

  ///LogIn Screen
  static String All_the_options_in_one_place = "सम्पूर्ण रोजगरीहरु एकैठाउँमा ";
...
//No data available
  ...
  static String Select_the_type_of_ID_card = 'परिचय पत्रको प्रकार छन्नुहोस ';
  static String SELECT_CAST = 'कास्ट चयन गर्नुहोस्';

  static String Please_stay = 'कृपया छन्नुहोस';

  static String select_gender = 'लिङ्ग छान्नुहोस् ';
  ...
  static String Please_enter_the_district = 'कृपया जिल्ला छन्नुहोस ';

  static String Please_be_a_municipality = 'कृपया नगरपालिका छन्नुहोस ';

  static String Please_choose_a_password = 'कृपया पासवर्ड छन्नुहोस ';
  ...
  static String Enter_your_email = 'आफ्नो इमेल प्रविष्ट गर्नुहोस्';
  static String Get_the_password = 'पासवर्ड प्राप्त गर्नुहोस्';

//Home Screen
  static String employment = 'रोजगरी';
  static String training = 'तालिम';
  static String employment_support_service_provider =
      'रोजगर समर्थन सेवा प्रदायक';
  static String training_service_provider = 'प्रशिक्षण सेवा प्रदायक ';
...
//Search Screen
  ...
  static String search_for = 'खोज्नुहोस';
...
// Employer list
  ...
  static String grade = 'श्रेणी';
  static String Related_jobs = 'सम्बन्धित रोजगरीहरू';

//JobDescriptionViewScreen
  static String deadline = 'म्याद :';
  static String Details_of_the_institution = 'संस्थाको विवरण';
  static String Service_Provider_Details = 'सेवा प्रदायकको विवरण';

  static String basic_job_information = 'आधारभूत काम जानकारी';
  static String Category_of_Employment = ' रोजगारिको वर्ग: ';
  static String Category_of_employment1 = 'रोजगारिको श्रेणी: ';
  static String Category_of_employment2 = 'रोजगारिको स‌ंख्या: ';
  static String Category_of_employment3 = 'रोजगारिको प्रकार: ';
  ...
  static String Training = "तालिम";
  static String Employment = "रोजगारी";
  ...
  static String Add_experience_edit = 'अनुभव सम्पादन गर्नुहोस्';
  static String Job_title = 'रोजगार शीर्षक';
  static String Name_of_the_institution = 'संस्थाकाे नाम';
  static String address = 'ठेगाना';
  static String start_date = 'सुरू मिति';
  static String Currently_working = 'हाल काम गर्दै';
  static String Currently_working1 = 'सुरू मिति';
  static String end_date = 'अन्त्य मिति';
  static String reference_name = 'सन्दर्भ नाम';
  static String Reference_Contact_No = 'सन्दर्भ सम्पर्क नम्बर';
  static String Experience_Certificate = 'अनुभव प्रमाणपत्र';

  static String Training_title = 'प्रशिक्षण शीर्षक';
  static String Training1 = 'प्रशिक्षण';
  static String period = 'अवधि';
  static String Experience_Certificate1 = 'अनुभव प्रमाणपत्र';
  ...
  static String reading = 'पढाइ';
  static String listening = 'बोलाई';
  ...
  static String Province1 = 'प्रदेश';
  static String Province2 = 'Select Province';
  static String District1 = 'जिल्ला';
  static String District2 = 'Select District';
  static String Village_Municipality = 'गाउँ/नगरपालिका';
  static String address1 = 'ठेगाना';
  ...
  static String Experience1 = 'अनुभव';
  ...
  static String social_media_account = 'सामाजिक मिडिया खाता';
  static String specialization = 'सामाजिक मिडिया खाता';
  ...
  static String Add_education = 'शिक्षा थप्नुहोस्';
  static String Add_education_edit = 'शिक्षा सम्पादन गर्नुहोस';
  static String Level = 'स्तर';
  static String board_of_Education = 'शिक्षा बोर्ड';
  static String Institution = 'संस्था';
  static String Program1 = 'कार्यक्रम';
  static String exam_passing_year = 'परीक्षा उत्तीर्ण वर्ष';
  static String marks_obtained = 'प्राप्त अंक';
  static String Add_expertise = 'विशेषज्ञाता थप्नुहोस';
  static String Add_a_social_media_account = 'सामाजिक मिडिया खाता थप्नुहोस्';
  ...
  static String name = 'नाम';
  static String mobile_number = 'मोबाइल नम्बर';
  static String Citizenship_no = 'नागरिकता नं';
  static String date_of_birth = 'जन्म मिति';
  ...
  static String district = 'जिल्ला ';
  static String municipality = 'नगरपालिका ';

  static String Temporary_Address = 'जअस्थायी ठेगाना';
  static String Permanent_Jas = 'स्थाई जस्तै';
  static String permanent_Address = 'स्थाई ठेगाना';

  static String State = 'प्रदेश';
  static String district1 = 'जिल्ला ';
  static String municipality1 = 'नगरपालिका';
  static String under = 'अन्तर्गत ';
  static String Update = 'अपडेट गर्नुहोस्';

  static String pmep = 'PMEP';

  static String Ethnicity = 'जातियता';
  static String Yadav = 'यादव';
  static String minor_group = 'नाबालिग समूह';

  static String no = 'हैन';

  static String SELECT_YES_NO = 'चयन गर्नुहोस्';
  static String SELECT_YES = 'हो';
