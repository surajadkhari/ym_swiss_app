...
class MyProfileProvider with ChangeNotifier{
  ...
  Future<ResponseModel> getMyProfile() async {
    ...
    if (apiResponse.response != null && apiResponse.response?.statusCode == 200) {
      ...
      var seen = Set<String>();
      List<Skills> uniquelist = myProfileModel!.data!.skills!.where((student) => seen.add(student.skillName!)).toList();
  ...
  Future<ResponseModel> getSkills() async {
    ...
    if (apiResponse.response != null && apiResponse.response?.statusCode == 200) {
     ...
     // skilsData?.addAll(skilsModel!.data!);
      var seen = Set<String>();
      List<SkilsData> uniquelist = skilsModel!.data!.where((student) => seen.add(student.name!)).toList();
  ...
  setEducationLavelDrobTitle(String educationLevelValueWord, String educationLevelHintValueword,int educationLevelHintValuewordId){
  ...
  Future<ResponseModel> postEducation(AddEducationModel addEducationModel) async {
    notifyListeners();
    ApiResponse apiResponse = await myProfileRepo.postEducation(addEducationModel);
    ResponseModel responseModel;
    int? responseCode = apiResponse.response?.statusCode;
  ...
  Future<ResponseModel> updateEducation(int id,AddEducationModel addEducationModel) async {
    notifyListeners();
    ApiResponse apiResponse = await myProfileRepo.updateEducation(id,addEducationModel);
    ResponseModel responseModel;
    int? responseCode = apiResponse.response?.statusCode;
...
///Language
  ...
  List<String> readingword = [AppConstants.Select_Rating, "1","2","3","4","5"];
  ...
  setAllLan(
    String readingValueWord,String readingHintValueword,String listeningValueWord,String listeningHintValueword,
    String writingValueWord,String writingHintValueword,String speackingValueWord,String speackingHintValueword){
    this.readingValueWord= readingValueWord;
    this.readingHintValueword= readingHintValueword;
    this.listeningValueWord= listeningValueWord;
    this.listeningHintValueword= listeningHintValueword;
  ...
  Future<ResponseModel> getDistricts() async {
    ...
    if (apiResponse.response != null && apiResponse.response?.statusCode == 200) {
      ...
      var seen = Set<String>();
      List<DistrictsData> uniquelist = districtsModel!.data!.where((student) => seen.add(student.name!)).toList();
  ...
  Future<ResponseModel> postPreferenceLocation(FormData formData) async {
    notifyListeners();
    ApiResponse apiResponse = await myProfileRepo.postPreferenceLocation(formData);
    ResponseModel responseModel;
    int? responseCode = apiResponse.response?.statusCode;
  ...
  setAllUpdateLocation(String pradeshName,int pradeshId ,String districtsName,int districtsId,String municipalitiesName,int municipalitiesId, ){
    this.pradeshName= pradeshName;
    this.pradeshId= pradeshId;
    this.districtsName= districtsName;
    this.districtsId= districtsId;
  ...
  Future<ResponseModel> updatePreferenceLocation(int id,FormData formData) async {
    notifyListeners();
    ApiResponse apiResponse = await myProfileRepo.updatePreferenceLocation(id,formData);
    ResponseModel responseModel;
    int? responseCode = apiResponse.response?.statusCode;
