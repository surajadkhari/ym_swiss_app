...
class TrainingsProvider with ChangeNotifier{
  ...
  Future<ResponseModel> getVewAllTraining(int pageId) async {
    viewAllTrainingsDataList = [];
    notifyListeners();
    ApiResponse apiResponse = await viewAllTrainingsRepo.getVewAllTraining(pageId);
  ...
  Future<ResponseModel> getVewSingleTraining(int id) async {
    notifyListeners();
    ApiResponse apiResponse = await viewAllTrainingsRepo.getVewSingleTraining(id);
    ResponseModel responseModel;
    int? responseCode = apiResponse.response?.statusCode;
  ...
  Future<ResponseModel> getSearchAllJob(String url, int pageId) async {
    viewAllTrainingsDataList = [];
    notifyListeners();
    ApiResponse apiResponse = await viewAllTrainingsRepo.getSearchAllJob(url,pageId);
    ResponseModel responseModel;
    int? responseCode = apiResponse.response?.statusCode;
