          ...
          child: Align(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (selectedValue) {
                setState(() {
                  genderId = locationProvider.genderDataInt!.indexOf(locationProvider.genderWord!.indexOf(selectedValue!));
        ...
        child: Container(
          ...
          child: Align(
            ...
            child: DropdownButton<String>(
              ...
              hint: Text(documentTypeHintValueword,
                style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                    fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
              iconSize: 30,
              value: documentTypeValueWord, //add this parameter
              items: locationProvider.documentTypeDataListS?.map((String dropDownStringItem) {
                return DropdownMenuItem(
                  value: dropDownStringItem,
                  child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                      fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Select_the_type_of_ID_card? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                );
              }).toList(),
              onChanged: (selectedValue) {
                setState(() {
                  ...
                  docType = locationProvider.documentTypeDataListId![locationProvider.documentTypeDataListS!.indexOf(documentTypeValueWord)];
