    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Consumer<JobProvider>(
          builder: (context, jobProvider, child) => Column(
            children: [
              // Container(
                  ...
                  children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: jobProvider.viewSingJobsModel
                                              ?.serviceProvider?.logo !=
                                          null
                                      ? Image.network(
                                          '${Apis.URL}${jobProvider.viewSingJobsModel?.serviceProvider?.logo}',
                                          height: 60,
                                          width: 60,
                                          fit: BoxFit.fill,
                                        )
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                    ...
                                    width: MediaQuery.of(context).size.width,
                                    child: Text(
                                      '${jobProvider.viewSingJobsModel?.title}',
                                      maxLines: 1,
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                              '  ${jobProvider.viewSingJobsModel?.deadline}',
                                              style: TextStyle(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppConstants.Details_of_the_institution,
                          style: TextStyle(
                              color: ColorsResource.TEXT_BLACK_COLOR,
                              fontSize: Dimensions.BODY_14,
                              fontWeight: Dimensions.FONT_BOLD),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${jobProvider.viewSingJobsModel?.organization?.name}',
                                style: TextStyle(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      width: MediaQuery.of(context).size.width -
                                          100,
                                      child: Text(
                                          '${jobProvider.viewSingJobsModel?.organization?.contactNumber}',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              fontSize: Dimensions.BODY_12,
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      width: MediaQuery.of(context).size.width -
                                          100,
                                      child: Text(
                                          '${jobProvider.viewSingJobsModel?.organization?.email}',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              fontSize: Dimensions.BODY_12,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppConstants.Service_Provider_Details,
                          style: TextStyle(
                              color: ColorsResource.TEXT_BLACK_COLOR,
                              fontSize: Dimensions.BODY_14,
                              fontWeight: Dimensions.FONT_BOLD),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${jobProvider.viewSingJobsModel?.serviceProvider?.name}',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_GRAY_COLOR_LOW,
                                    fontSize: Dimensions.BODY_14),
                              ),
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      width: MediaQuery.of(context).size.width -
                                          100,
                                      child: Text(
                                          '${jobProvider.viewSingJobsModel?.serviceProvider?.mobile}',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              fontSize: Dimensions.BODY_12,
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      width: MediaQuery.of(context).size.width -
                                          100,
                                      child: Text(
                                          '${jobProvider.viewSingJobsModel?.serviceProvider?.email}',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              fontSize: Dimensions.BODY_12,
                    ...
                    Text(
                      AppConstants.basic_job_information,
                      style: TextStyle(
                          color: ColorsResource.TEXT_BLACK_COLOR,
                          fontSize: Dimensions.BODY_14,
                          fontWeight: Dimensions.FONT_BOLD),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(
                                '${AppConstants.Category_of_Employment}',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_BOLD),
                              ...
                              Text(
                                '${jobProvider.viewSingJobsModel?.categoryName}',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_MEDIUM_NORMUL),
                          ...
                          Row(
                            children: [
                              Text(
                                '${AppConstants.Category_of_employment2} ',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_BOLD),
                              ...
                              Text(
                                '${jobProvider.viewSingJobsModel?.openings}',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_MEDIUM_NORMUL),
                          ...
                          Row(
                            children: [
                              Text(
                                '${AppConstants.Category_of_employment3} ',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_BOLD),
                              ...
                              Text(
                                ' ${jobProvider.viewSingJobsModel?.positionType}',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_MEDIUM_NORMUL),
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                ' ${jobProvider.viewSingJobsModel?.salaryMin} - ${jobProvider.viewSingJobsModel?.salaryMax}',
                                style: TextStyle(
                                    color: ColorsResource.TEXT_BLACK_COLOR,
                                    fontSize: Dimensions.BODY_12,
                                    fontWeight: Dimensions.FONT_MEDIUM_NORMUL),
                    ...
                    Container(
                      ...
                      child: HtmlView(
                          '${jobProvider.viewSingJobsModel?.description}'),
                    ),
                    SizedBox(
                      height: 10,
                    ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ' ${jobProvider.viewSingJobsModel?.requiredEducation}',
                                    style: TextStyle(
                                        color: ColorsResource.TEXT_BLACK_COLOR,
                                        fontSize: Dimensions.BODY_12,
                                        fontWeight:
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ' ${jobProvider.viewSingJobsModel?.requiredExperience} ',
                                  style: TextStyle(
                                      color: ColorsResource.TEXT_BLACK_COLOR,
                                      fontSize: Dimensions.BODY_12,
                                      fontWeight:
          ...
          return Dialog(
            ...
            child: Container(
              ...
              child: Consumer<UtilProvider>(
                builder: (context, utilProvider, child) => Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Visibility(
                                visible: utilProvider.fileName == null
                                    ? false
                                    : true,
                                child: Container(
                              ...
                              SizedBox(
                                height: utilProvider.fileName == null ? 30 : 5,
                              ),
                              Container(
                                width: 200,
                                height: 20,
                              ...
                              Container(
                                  ...
                                  child: Align(
                                      alignment: Alignment.center,
                                      child: Text(
                                        AppConstants.Keep_an_updated_CV,
                                        style: TextStyle(
                                            fontSize: Dimensions.BODY_12,
                                            color: ColorsResource
                                                .PRAYMARY_TEXT_COLOR),
                          ...
                          CustomSearchButton(
                              utilProvider.isLoading == true
                                  ? '${utilProvider.currentParsent}'
                                  : AppConstants.Apply, () async {
                            String? token = "";
                            ...
                            if (response.statusCode == 200) {
                              ...
                              Provider.of<JobProvider>(context, listen: false)
                                  .getSingVewJob(widget.viewAllJobDataF.id!);
