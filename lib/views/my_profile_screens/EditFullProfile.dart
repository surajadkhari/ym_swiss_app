...
class _EditFullProfileState extends State<EditFullProfile> {
  ...
  List<String> minorGroupklassenword = [AppConstants.SELECT_YES_NO, AppConstants.SELECT_YES,AppConstants.SELECT_NO, ];
  ...
  List<String> migrantWorkersklassenword =  [AppConstants.SELECT_YES_NO,AppConstants.SELECT_YES,AppConstants.SELECT_NO, ];
  ...
  List<String> disabledklassenword = [AppConstants.SELECT_YES_NO,AppConstants.SELECT_YES,AppConstants.SELECT_NO,];
  ...
  String? pleaseTheDistrictHintValueWord = AppConstants.Please_enter_the_district;
  int? pleaseTheDistrictWordsId = 0;



  var pleaseMunicipalityValueWord = AppConstants.Please_be_a_municipality;
  String? pleaseMunicipalityHintValueWord = AppConstants.Please_be_a_municipality;
  ...
  String? tPleaseTheDistrictHintValueWord = AppConstants.Please_enter_the_district;
  int? tPleaseTheDistrictWordsId = 0;


  String? tPleaseMunicipalityValueWord = AppConstants.Please_be_a_municipality;
  String? tPleaseMunicipalityHintValueWord = AppConstants.Please_be_a_municipality;
  ...
  void initState() {
   ...
   WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
     ...
     if(myProfileModel.data?.citizenshipNo != null){
       citizenshipNoTextEditingController.text = myProfileModel.data!.citizenshipNo!;
     }
    ...
    if(myProfileData?.jobseekerPreferenceCategory != null){
      if(myProfileData!.jobseekerPreferenceCategory!.length > 0){
        String? categoryName = myProfileData.jobseekerPreferenceCategory?[myProfileData.jobseekerPreferenceCategory!.length -1].categoryName;
        int? id = int.parse(myProfileData.jobseekerPreferenceCategory![myProfileData.jobseekerPreferenceCategory!.length -1].categoryId!);
    ...
    if(myProfileModel.data!.differentlyAble != null ){
     ...
     locationProvider.getCast().then((value) {
       ...
       if(myProfileModel.data!.ethnicityType != null ){
         ...
         castValueWordId = id;
         String castName = locationProvider.castDataListString![locationProvider.castDataListInt!.indexOf(castValueWordId)];
     ...
     locationProvider.getPradesh().then((value) {
        ...
        locationProvider.getDistricts(pradashWordsId!).then((value) {
         ...
         locationProvider.getMunicipalities(pleaseTheDistrictWordsId!).then((value) {
        ...
        locationProvider.tGetPradesh().then((value) {
          ...
          locationProvider.tGetDistricts(tPradashWordsId!).then((value) {
            ...
            locationProvider.tGetMunicipalities(tPleaseTheDistrictWordsId!).then((value) {
                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10,),
                        CustomTextFieldWithTitle(AppConstants.NAME,nameTextEditingController,nameFocusNode,isBold:false,isShowRequrStar:true),
                        ...
                        genderDropdown(),
                        const SizedBox(height: 5,),
                        CustomTextFieldWithTitle(AppConstants.mobile_number,mobileNumberTextEditingController,mobileNumberFocusNode,isBold:false,isShowRequrStar:true),
                        const SizedBox(height: 5,),
                        CustomTextFieldWithTitle(AppConstants.Citizenship_no,citizenshipNoTextEditingController,citizenshipNoFocusNode,isBold:false,isShowRequrStar:true,inputType:AppConstants.PHONE,),
                        const SizedBox(height: 5,),
                        Row(
                          children: [
                            Text( '${AppConstants.date_of_birth}',
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                          Text( ' *',
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_READ_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                        ...
                        const SizedBox(height: 5,),
                        CustomTextFieldWithTitle(AppConstants.expected_summons,expectedSummonsTextEditingController,expectedSummonsFocusNode,isBold:false,inputType:AppConstants.PHONE,),
                        const SizedBox(height: 10,),




                        Text(AppConstants.Profile_photo,
                          style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                flex: 1,
                                child: Text(  imageName == '' ? imageName2: imageName),
                              ),
                            ],
                          ),
                        ),
                        ...
                        Row(
                          children: [
                            Text( '${AppConstants.Choose_your_area_of_expertise}',
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                          ],
                        ),
                       // jobCategoryDropdown(),
 ...
 const SizedBox(height: 20,),
                        ...
                        Row(
                          children: [
                            Text(AppConstants.permanent_Address,
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                        ...
                        Row(
                          children: [
                            Text(AppConstants.temporary_address,
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                            Text(" *",
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: Colors.redAccent,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),

                            Expanded(child: Container()),

                            Text(AppConstants.Permanent_Jas,
                              style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                            Checkbox(
                              value: valuefirst,
                        ...
                        SizedBox(height: 20,),
                        Text( '${AppConstants.pmep} ${AppConstants.under}',
                          style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM),),
                        Container(
                        ...
                        Visibility(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text( '${AppConstants.Migrant_workers}',
                                    style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_BLACK_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),),
                                  Text(" *",
                                    style: TextStyle(fontSize: Dimensions.BODY_14,color: ColorsResource.TEXT_READ_COLOR,fontWeight: Dimensions.FONT_MEDIUM_NORMUL),
                                  )
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomButton(AppConstants.Update1,() async{
                                ...
                                MyProfileModel? myProfileModel = widget.myProfileModel;
                               ...
                               int gender = locationProvider.genderValueWordId;
                                ...
                                if(citizenshipNo == ''){
                                  return showCustomSnackBar('citizenshipNo',context);
                                }
                                if(dobDateTime == 'YYY/MM/DD'){
                                  return showCustomSnackBar('Enter day of birth',context);
                                }
                                int showPemOption = 1;
                                if(isVisibleTopHint){
                                  showPemOption = 1;
        ...
        child: Container(
          ...
          child: Align(
            ...
            child: DropdownButton<String>(
              ...
              hint: Text(locationProvider.genderValueWord,
              ...
              items: locationProvider.genderWord?.map((String dropDownStringItem) {
                return DropdownMenuItem(
                  value: dropDownStringItem,
                  child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                      fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.select_gender? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                );
              }).toList(),
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(pleasePradashHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  ...
                  items: locationProvider.pradashWords?.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.please_state_channuhos? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                    );
                  }).toList(),
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      pradashWordsId = locationProvider.pradashWordsIdList![locationProvider.pradashWords!.indexOf(selectedValue)];
                      print('11  ${pradashWordsId}');


                      if(pradashWordsId != 0){
                        pleaseTheDistrictValueWord= AppConstants.Please_enter_the_district;
                        pleaseTheDistrictHintValueWord = AppConstants.Please_enter_the_district;
                      }
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(pleaseTheDistrictHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  ...
                  items: locationProvider.pleaseTheDistrictWords.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_enter_the_district? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                    );
                  }).toList(),
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      if(pleaseTheDistrictWordsId != 0){
                        pleaseMunicipalityValueWord = AppConstants.Please_be_a_municipality;
                        pleaseMunicipalityHintValueWord = AppConstants.Please_be_a_municipality;
                      }

                      pleaseTheDistrictValueWord= selectedValue!;
                      pleaseTheDistrictHintValueWord = selectedValue;
                      pleaseTheDistrictWordsId = locationProvider.pleaseTheDistrictWordsIdList[locationProvider.pleaseTheDistrictWords.indexOf(selectedValue)];
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(pleaseMunicipalityHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  value: pleaseMunicipalityValueWord, //add this parameter
                  items: locationProvider.pleaseMunicipalityWords.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_be_a_municipality?
                          ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                    );
                  }).toList(),
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      print('333 1 ${locationProvider.pleaseMunicipalityWords.indexOf(selectedValue)}');

                      pleaseMunicipalityWordsId = locationProvider.pleaseMunicipalityWordsIdList[locationProvider.pleaseMunicipalityWords.indexOf(selectedValue)];
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  items: locationProvider.pleaseSeletcWardValueWords?.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_be_a_ward?
                          ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                    );
                  }).toList(),
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      pleaseSeletcWardValueWordsId = int.parse(pleaseSeletcWardValueWord);
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(tPleasePradashHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  ...
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      tPradashWordsId = locationProvider.pradashWordsIdList![locationProvider.pradashWords!.indexOf(selectedValue)];
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(tPleaseTheDistrictHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  value: tPleaseTheDistrictValueWord, //add this parameter
                  items: valuefirst ? locationProvider.pleaseTheDistrictWords.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_enter_the_district? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                    );
                  }).toList() : locationProvider.tPleaseTheDistrictWords.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_enter_the_district? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                  ...
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      tPleaseTheDistrictWordsId = locationProvider.tPleaseTheDistrictWordsIdList[locationProvider.tPleaseTheDistrictWords.indexOf(selectedValue)];
                      ...
                      locationProvider.tGetMunicipalities(tPleaseTheDistrictWordsId!);
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(tPleaseMunicipalityHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  value: tPleaseMunicipalityValueWord, //add this parameter
                  items: valuefirst ?  locationProvider.pleaseMunicipalityWords.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_be_a_municipality?
                  ...
                  }).toList() :locationProvider.tPleaseMunicipalityWords.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_be_a_municipality?
                  ...
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      tPleaseMunicipalityWordsId = locationProvider.tPleaseMunicipalityWordsIdList[locationProvider.tPleaseMunicipalityWords.indexOf(selectedValue)];
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(tpleaseSeletcWardHintValueWord!,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  ...
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      tPleaseSeletcWardValueWordsId = int.parse(tPleaseSeletcWardValueWord!);
        ...
        child: Container(
          ...
          child: Align(
            ...
            child: DropdownButton<String>(
              ...
              hint: Text(castHintValueword,
                style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                    fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
              iconSize: 30,
              value: castValueWord, //add this parameter
              items: locationProvider.castDataListString?.map((String dropDownStringItem) {
                return DropdownMenuItem(
                  value: dropDownStringItem,
                  child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                      fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.SELECT_CAST? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                );
              }).toList(),
              onChanged: (selectedValue) {
                setState(() {
                  ...
                  castValueWordId = locationProvider.castDataListInt![locationProvider.castDataListString!.indexOf(selectedValue)];
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: DropdownButton<String>(
            ...
            hint: Text(minorGroupHintValueword,
              style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                  fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
            iconSize: 30,
            ...
            items: minorGroupklassenword.map((String dropDownStringItem) {
              return DropdownMenuItem(
                value: dropDownStringItem,
                child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                    fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.SELECT_YES_NO? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
              );
            }).toList(),
            onChanged: (selectedValue) {
              setState(() {
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: DropdownButton<String>(
            ...
            hint: Text(migrantWorkersHintValueword,
              style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                  fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
            iconSize: 30,
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: DropdownButton<String>(
            ...
            hint: Text(disabledHintValueword,
              style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                  fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
            iconSize: 30,
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: DropdownButton<String>(
                  ...
                  hint: Text(jobCategoryHintValueWord,
                    style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                        fontSize: Dimensions.BODY_16,color: ColorsResource.TEXT_GRAY_COLOR),),
                  iconSize: 30,
                  value: jobCategoryValueWord, //add this parameter
                  items: locationProvider.viewAllJobCategoryDataListSting?.map((String dropDownStringItem) {
                    return DropdownMenuItem(
                      value: dropDownStringItem,
                      child: Text( dropDownStringItem,style: TextStyle(fontWeight: Dimensions.FONT_MEDIUM_NORMUL,
                          fontSize: Dimensions.BODY_16,color: dropDownStringItem != AppConstants.Please_stay? ColorsResource.TEXT_BLACK_COLOR:ColorsResource.TEXT_GRAY_COLOR),),
                    );
                  }).toList(),
                  onChanged: (selectedValue) {
                    setState(() {
                      ...
                      jobCategoryValueWordId = locationProvider.viewAllJobCategoryDataListId![locationProvider.viewAllJobCategoryDataListSting!.indexOf(jobCategoryValueWord)];
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(width: 10,),
                                Text('कृपया छन्नुहोस्',style: TextStyle(color: ColorsResource.PRAYMARY_TEXT_COLOR,fontSize: Dimensions.BODY_14),),
                                Expanded(child: Container()),
                                InkWell(
                                  onHover: (_){},
                                  onTap: (){
                            ...
                            child: Container(
                              ...
                              child: SingleChildScrollView(
                                child: MultiSelectFormField(
                                  ...
                                  title: Text('कृपया छन्नुहोस्', style: const TextStyle(fontSize: 10),),
                                  validator: (value) {
                                  ...
                                  dataSource: locationProvider.allJobCategoryDataList,
                                  textField: 'display',
                                  valueField: 'value',
                                  okButtonLabel: 'OK',
                                  ...
                                  onSaved: (value) {
                                    ...
                                    setState(() {
                                      ...
                                      _myActivities?.forEach((element) {
                                        String name = locationProvider.viewAllJobCategoryDataListSting![locationProvider.viewAllJobCategoryDataListId!.indexOf( int.parse(element))];
