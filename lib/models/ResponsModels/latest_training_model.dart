...
class LatestTrainingModel {
    ...
    factory LatestTrainingModel.fromJson(Map<String, dynamic> json) => LatestTrainingModel(
        ...
        engEndDate: DateTime.parse(json["eng_end_date"]),
...
class ServiceProvider {
    ...
    factory ServiceProvider.fromJson(Map<String, dynamic> json) => ServiceProvider(
        ...
        description: json["description"]??'',
        logo: json["logo"]??"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/681px-Placeholder_view_vector.svg.png?20220519031949",
    );
